...
data class GJavaDoubleArrayType<CTX: Any>(override val gqlType: GType, override val elementType: GJavaType<CTX>) : GJavaListLikeType<CTX>() {
    override val type: KType = DoubleArray::class.createType()

    override val name = ResolvedName.forBaseline(gqlType.kind != TypeKind.NON_NULL, "DoubleArray")
    ...
    override fun transformFromJson(array: ValueList, inputVarParser: InputVarParser<CTX>): DoubleArray {
        return BaselineInputParser.parseDoubleArrayNotNull(array, inputVarParser.inputVariables)
    }
